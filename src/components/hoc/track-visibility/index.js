  ...
  return class Visibility extends React.Component {
    constructor(props) {
      ...
      this.state = {
        ...
        isIntersected: false,
        unregisterOnIntersect:
          options.unregisterOnIntersect || defaultOptions.unregisterOnIntersect
      };
      ...
      return (
        <div
          ...
          className={classnames(
            "track-visible",
            this.state.wasIntersected ? "was-visible" : "",
            this.state.isIntersected ? "is-visible" : ""
          )}
        >
