...
class Polyhedrons extends React.Component {
  ...
  componentDidMount() {
    ...
    this.setState({ animated: startShape, keyframe: randKeyframe() }, () =>
      this.state.animationChange.next(startShape)
    );
    ...
    this.animationInterval = setInterval(() => {
      ...
      this.setState({ animated, keyframe: randKeyframe() }, () =>
        this.state.animationChange.next(animated)
      );
    }, 11000);
  }
      ...
      <div className="scene">
        <div className="shapes">
          <Polyhedron
            ...
            animationChange={this.state.animationChange}
          >
            <Face />
            <Face />
            <Face />
