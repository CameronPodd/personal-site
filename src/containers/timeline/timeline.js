            ...
            <tbody style={{ backgroundColor: data.color || defaultData.color }}>
              <tr style={{ backgroundColor: data.color || defaultData.color }}>
                <th
                  key={0}
                  className="ribbon"
                  style={{ backgroundColor: data.color || defaultData.color }}
                >
                ...
                {data.entries.map(
                  (entry, _i) =>
                    entry.content && (
                      <th
                        key={_i + 1}
                        className="ribbon timeline-entry"
                        style={{
                          backgroundColor: data.color || defaultData.color
                        }}
                      >
                        <div className={entry.shape || defaultData.shape}>
                          {/* ribbon point */}
                        </div>
                        ...
                        <style
                          dangerouslySetInnerHTML={{
                            __html: `
                      ul.timeline li:nth-child(${i +
                        1}) th.timeline-entry:nth-child(${_i + 2}) > div:after {
